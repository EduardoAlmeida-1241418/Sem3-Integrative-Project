...
CREATE TABLE Train (
  ...
  Date_TimeID_Date_Time number(10) NOT NULL, 
...
CREATE TABLE Schedule (
  ...
  In_Movement                 char(1) NOT NULL, 
  TrainID_Train               number(10) NOT NULL, 
  Start_Date_TimeID_Date_Time number(10) NOT NULL, 
  Final_Date_TimeID_Date_Time number(10) NOT NULL, 
  Start_PositionID_Position   number(10) NOT NULL, 
  End_PositionID_Position     number(10) NOT NULL, 
  PRIMARY KEY (ID_Schedule));
CREATE TABLE Date_Time (
  ID_Date_Time number(10) NOT NULL, 
  "Date"       date NOT NULL, 
...
CREATE TABLE Position (
  ...
  Rail_Line_SegmentID_Rail_Line_Segment number(10), 
...
ALTER TABLE Freight ADD CONSTRAINT FKFreight246020 FOREIGN KEY (TrainID_Train) REFERENCES Train (ID_Train);
ALTER TABLE Siding ADD CONSTRAINT FKSiding723931 FOREIGN KEY (Rail_Line_SegmentID_Rail_Line_Segment) REFERENCES Rail_Line_Segment (ID_Rail_Line_Segment);
ALTER TABLE Schedule ADD CONSTRAINT FKSchedule501902 FOREIGN KEY (TrainID_Train) REFERENCES Train (ID_Train);
ALTER TABLE Train ADD CONSTRAINT FKTrain25509 FOREIGN KEY (Date_TimeID_Date_Time) REFERENCES Date_Time (ID_Date_Time);
ALTER TABLE Schedule ADD CONSTRAINT FKSchedule806053 FOREIGN KEY (Start_Date_TimeID_Date_Time) REFERENCES Date_Time (ID_Date_Time);
ALTER TABLE Schedule ADD CONSTRAINT FKSchedule477714 FOREIGN KEY (Final_Date_TimeID_Date_Time) REFERENCES Date_Time (ID_Date_Time);
ALTER TABLE Position ADD CONSTRAINT FKPosition693674 FOREIGN KEY (FacilityID_Facility) REFERENCES Facility (ID_Facility);
ALTER TABLE Position ADD CONSTRAINT FKPosition549254 FOREIGN KEY (Rail_Line_SegmentID_Rail_Line_Segment) REFERENCES Rail_Line_Segment (ID_Rail_Line_Segment);
ALTER TABLE Position ADD CONSTRAINT FKPosition712653 FOREIGN KEY (SidingID_Siding) REFERENCES Siding (ID_Siding);
ALTER TABLE Schedule ADD CONSTRAINT FKSchedule503856 FOREIGN KEY (Start_PositionID_Position) REFERENCES Position (ID_Position);
ALTER TABLE Schedule ADD CONSTRAINT FKSchedule12168 FOREIGN KEY (End_PositionID_Position) REFERENCES Position (ID_Position);
