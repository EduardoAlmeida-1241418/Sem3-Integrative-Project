 ...
 */
public class OperationsAnalystNOSController {
     ...
     */
    public OperationsAnalystNOSController() {
     ...
     */
    public ObservableList<Log> getFilteredLogs() {
        ObservableList<Log> filteredLogs = FXCollections.observableArrayList();
