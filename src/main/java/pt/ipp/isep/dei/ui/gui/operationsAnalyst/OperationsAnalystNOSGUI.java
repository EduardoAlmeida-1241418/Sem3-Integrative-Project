...
import pt.ipp.isep.dei.controller.operationsAnalyst.OperationsAnalystNOSController;
 ...
 */
public class OperationsAnalystNOSGUI implements Initializable {

    private OperationsAnalystNOSController controller;
    private UIUtils uiUtils;

    @FXML private ListView<Log> listViewLogs;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        controller = new OperationsAnalystNOSController();
        uiUtils = new UIUtils();
    ...
    private void configureColoredLogs() {
        listViewLogs.setCellFactory(_lv -> new javafx.scene.control.ListCell<>() {
            @Override
            protected void updateItem(Log item, boolean empty) {
                ...
                RoleType role = item.getRoleType();
